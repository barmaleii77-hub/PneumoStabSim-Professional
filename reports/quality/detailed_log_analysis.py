...
def analyze_errors():
    ...
    for line in error_lines:
        ...
        elif 'fog' in line_lower and ('effect' in line_lower or 'manifest' in line_lower):
    ...
    if categories['fog_effect']:
        ...
        # Типы проблем
        manifest_errors = len([e for e in categories['fog_effect'] if 'manifest mismatch' in e])
        normalization_errors = len([e for e in categories['fog_effect'] if 'normalization skipped' in e])
