...
class TestTab(QWidget):
    ...
    def __init__(self, test_name, qml_code, expected_bg, expected_obj, parent=None):
        ...
        info.setStyleSheet(
            "background: #333; color: #fff; padding: 5px; font-size: 11pt;"
        )
    ...
    def update_status(self):
        ...
        if status == QQuickWidget.Status.Error:
            ...
            self.status_label.setStyleSheet(
                "background: #000; color: #f00; padding: 5px; font-family: monospace;"
            )
...
class ComprehensiveTestWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        instructions.setStyleSheet(
            "background: #1a1a2e; color: #fff; padding: 10px; font-size: 11pt;"
        )
        ...
        tabs.addTab(
            TestTab(
                "Test 1: Minimal", QML_TEST_1_MINIMAL, "RED (#ff0000)", "GREEN sphere"
            ),
            "1: Minimal",
        )
        ...
        tabs.addTab(
            TestTab(
                ...
                QML_TEST_5_MULTIPLE,
                "DARK GRAY (#2a2a2a)",
                "RED sphere + GREEN cube + BLUE cylinder",
            ),
            "5: Multiple",
        )
        ...
        result_label.setStyleSheet(
            "background: #2a2a3e; color: #fff; padding: 10px; font-size: 10pt;"
        )
        ...
        print(
            "Tab 5 (Multiple): Expected 3 objects (red sphere, green cube, blue cylinder)"
        )
        print()
