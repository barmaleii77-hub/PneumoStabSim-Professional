...
class MinimalTestWindow(QWidget):
    def __init__(self):
        ...
        info.setStyleSheet("background-color: #000; color: #0f0; padding: 5px; font-size: 12pt; font-weight: bold;")
        ...
        self.status_label.setStyleSheet("background-color: #000; color: #0f0; padding: 5px; font-family: monospace;")
