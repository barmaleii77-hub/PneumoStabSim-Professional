...
class TestGeometryInvariants(unittest.TestCase):
    ...
    def test_stroke_angle_calibration(self):
        ...
        assert_allclose(
            ...
            0.0,
            atol=1e-6,
            err_msg="Zero angle should produce zero stroke"
        )
    ...
    def test_lever_geometry_consistency(self):
        ...
        self.assertGreater(
            pivot_distance,
            0.0,
            "Pivot distance must be positive"
        )
    ...
    def test_dead_zones_non_negative(self):
        ...
        self.assertGreater(
            ...
            0.0,
            "Compressed dead zone must be positive"
        )
        
        self.assertGreater(
            dead_zone_extended,
            0.0,
            "Extended dead zone must be positive"
        )
...
class TestGeometryEdgeCases(unittest.TestCase):
    ...
    def test_extreme_aspect_ratio(self):
        ...
        self.assertGreater(
            aspect_ratio_short,
            0.1,
            "Aspect ratio too small (pancake cylinder)"
        )
        
        self.assertLess(
            aspect_ratio_long,
            20.0,
            "Aspect ratio too large (telescope cylinder)"
        )
