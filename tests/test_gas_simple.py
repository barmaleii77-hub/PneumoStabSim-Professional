...
from src.pneumo.gas_state import (
    ...
    apply_instant_volume_change, create_line_gas_state, create_tank_gas_state
)
...
class TestGasProcesses(unittest.TestCase):
    ...
    def test_tank_volume_modes(self):
        ...
        # NO_RECALC mode
        tank_no_recalc = create_tank_gas_state(0.001, PA_ATM, T_AMBIENT, ReceiverVolumeMode.NO_RECALC)
        ...
        tank_adiabatic = create_tank_gas_state(0.001, PA_ATM, T_AMBIENT, ReceiverVolumeMode.ADIABATIC_RECALC)
