...
class TestIsothermalProcess(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.gas = GasState(pressure=self.p0, temperature=self.T_const, volume=self.V0)
...
class TestAdiabaticProcess(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.gas = GasState(pressure=self.p0, temperature=self.T0, volume=self.V0)
...
class TestModeConsistency(unittest.TestCase):
    ...
    def test_energy_conservation(self):
        ...
        assert_allclose(
            dU, W, rtol=5e-4, err_msg=f"Energy balance: dU={dU:.2f}J, W={W:.2f}J"
        )
