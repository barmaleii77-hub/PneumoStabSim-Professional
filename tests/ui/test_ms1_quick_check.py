...
print(
    f" 'cyl_diam_m' в parameters: {('cyl_diam_m' in params)} = {params.get('cyl_diam_m', 'НЕ НАЙДЕНО')}"
)
print(
    f" 'stroke_m' в parameters: {('stroke_m' in params)} = {params.get('stroke_m', 'НЕ НАЙДЕНО')}"
)
print(
    f" 'dead_gap_m' в parameters: {('dead_gap_m' in params)} = {params.get('dead_gap_m', 'НЕ НАЙДЕНО')}"
)
