...
from src.ui.panels.modes.defaults import MODE_PRESETS
...
def test_state_manager_initialization():
    ...
    assert options["include_springs"] is True
    assert options["include_dampers"] is True
    assert options["include_pneumatics"] is True
...
def test_api_compatibility():
    ...
    assert panel.control_tab._simulation_running is True
    print("✅ set_simulation_running(True) works")

    panel.set_simulation_running(False)
    assert panel.control_tab._simulation_running is False
