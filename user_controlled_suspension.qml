...
View3D {
    ...
    property real leverLength: userLeverLength  // Distance from pivot to rod attachment
    ...
    component CorrectedSuspensionCorner: Node {
        ...
        Model {
            ...
            property real lBody: parent.parent.userCylinderLength  // USER-CONTROLLED cylinder length
            property real lTailRod: parent.parent.userTailRodLength  // USER-CONTROLLED tail rod length
