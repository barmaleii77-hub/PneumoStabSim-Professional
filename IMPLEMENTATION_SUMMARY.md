...
Начиная с текущей итерации, оба слайдера управляют процедурной геометрией
цилиндров подвески в реальном времени: при увеличении значений сцена
перестраивает меш с новым числом сегментов и колец без необходимости
перезапуска.
