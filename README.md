...
> ℹ️ Скрипты `run.bat`, `run.ps1` и `setup_environment.sh` автоматически выставляют `QSG_RHI_BACKEND=opengl`, гарантируя запуск Qt Quick 3D на профиле OpenGL 3.3+.
...
- **OpenGL 3.3+** совместимая видеокарта (backend `QSG_RHI_BACKEND=opengl`)
