...
- **PySide66.5–6.10** (базовый таргет6.10.x)
- **Windows10/11** (рекомендуется) или Linux/macOS
- **4GB RAM** минимум,8GB рекомендуется
- **DirectX11** совместимая видеокарта
...
> ℹ️ Подробности по матрице версий и контрольным проверкам – в [docs/environments.md](docs/environments.md).
