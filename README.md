...
1. Убедитесь, что у вас установлен Python 3.13 (поддерживаются также 3.12 и 3.11) и доступна утилита `make`.
...
### 1. Требования
- **Python 3.13** (протестировано на 3.13.0; Python 3.12 и 3.11 поддерживаются в режиме совместимости)
