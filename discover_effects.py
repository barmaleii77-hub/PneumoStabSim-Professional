...
def discover_qt_effects():
    ...
    try:
        ...
        potential_effects = [
            # Основные эффекты
            "Bloom", "BloomEffect", "Glow", "GlowEffect",
            
            # SSAO эффекты  
            "SSAO", "SSAOEffect", "AmbientOcclusion", 
            
            # Tone mapping
            "ToneMapping", "TonemappingEffect", "Tonemap",
            
            # Depth of Field
            "DepthOfField", "DepthOfFieldEffect", "DOF",
            
            # Другие эффекты
            "Blur", "BlurEffect", "MotionBlur", "MotionBlurEffect",
            "Vignette", "VignetteEffect", "ColorGrading", "ColorGradingEffect",
            "ChromaticAberration", "FilmGrain", "Sharpen", "Noise",
            
            # Специальные эффекты
            "Fog", "FogEffect", "Scattering", "ScatteringEffect",
            "LensFlare", "GodRays", "Volumetric"
        ]
