...
| ``current.animation.amplitude`` | 8.0 | type: float | src/ui/panels_accordion.py:636<br>src/ui/environment_schema.py:211<br>src/ui/main_window_backup.py:681 |
| ``current.animation.animation_time`` | 0.0 | type: float | src/ui/main_window_pkg/signals_router.py:548 |
| ``current.animation.frequency`` | 1.0 | type: float | src/ui/panels_accordion.py:652<br>src/ui/environment_schema.py:213<br>src/ui/main_window_backup.py:682 |
| ``current.animation.is_running`` | false | type: bool | src/ui/environment_schema.py:209<br>src/ui/main_window_pkg/signals_router.py:573 |
| ``current.animation.phase_fl`` | 0.0 | type: float | src/ui/main_window_pkg/signals_router.py:558<br>assets/qml/PneumoStabSim/SimulationRoot.qml:1999 |
| ``current.animation.phase_fr`` | 0.0 | type: float | src/ui/main_window_pkg/signals_router.py:560<br>assets/qml/PneumoStabSim/SimulationRoot.qml:2000 |
| ``current.animation.phase_global`` | 0.0 | type: float | src/ui/main_window_backup.py:683<br>src/ui/main_window_pkg/signals_router.py:552<br>assets/qml/PneumoStabSim/SimulationRoot.qml:1998 |
| ``current.animation.phase_rl`` | 0.0 | type: float | src/ui/main_window_pkg/signals_router.py:562<br>assets/qml/PneumoStabSim/SimulationRoot.qml:2001 |
| ``current.animation.phase_rr`` | 0.0 | type: float | src/ui/main_window_pkg/signals_router.py:564<br>assets/qml/PneumoStabSim/SimulationRoot.qml:2002 |
