...
| ``current.modes.physics.include_dampers_kinematics`` | true | type: boolean | src/ui/panels/modes/physics_tab.py:109<br>qml/SimulationPanel.qml:1432-1442 |
...
| ``current.modes.physics.include_springs_kinematics`` | true | type: boolean | src/ui/panels/modes/physics_tab.py:101<br>qml/SimulationPanel.qml:1428-1436 |
...
| ``current.modes.sim_type`` | "KINEMATICS" | type: string | src/ui/main_window_backup.py:819<br>src/ui/panels/panel_modes.py:465<br>src/ui/panels/modes/defaults.py:15<br>qml/SimulationPanel.qml:1337-1349 |
| ``current.modes.thermo_mode`` | "ISOTHERMAL" | type: string | src/ui/panels/modes/defaults.py:16<br>qml/SimulationPanel.qml:1351-1362<br>src/ui/main_window_pkg/signals_router.py:1455-1496 |
| ``current.modes.road_profile`` | "smooth_highway" | type: string | qml/SimulationPanel.qml:1370-1387<br>config/app_settings.json:247 |
| ``current.modes.custom_profile_path`` | "" | type: string | qml/SimulationPanel.qml:1390-1396<br>src/ui/main_window_pkg/signals_router.py:1455-1496 |
| ``current.modes.check_interference`` | false | type: boolean | qml/SimulationPanel.qml:1398-1403<br>src/ui/main_window_pkg/signals_router.py:1455-1496 |
| ``current.modes.ambient_temperature_c`` | 20.0 | type: number | qml/SimulationPanel.qml:1593-1609<br>src/ui/main_window_pkg/signals_router.py:1455-1496 |
...
| ``metadata.version`` | "4.9.8" | type: string | — |
