...
| Визуализация ресивера (`Receiver.qml`) | Сферические индикаторы давления по диагоналям | Масштаб и цвет по давлению, позиции из геометрии рамы | 【F:assets/qml/PneumoStabSim/scene/Receiver.qml†L1-L218】 |
...
## 13. Статус выполнения требований (март 2026)

- [x] Аудит архивов завершён: в репозитории оставлены только индексированные материалы `archive/2025-11/*` и легаси QML-бэкапы; дубликаты `archive/reports` и `archive/old_qml` удалены. 【F:README.md†L225-L228】
- [x] Текущая версия UI-документации отражает активные панели и виджеты, включая статус legacy-компонентов. 【F:docs/MODULES/UI_PANELS_WIDGETS.md†L1-L96】
- [x] Панели геометрии и режимов подтверждают работу через `SettingsManager`, обеспечивая отсутствие хардкодированных дефолтов. 【F:src/ui/panels/panel_geometry.py†L44-L108】【F:src/ui/panels/panel_modes.py†L1-L77】
- [ ] Требуется обновить упоминания Qt 6.5 в фазовых планах на Qt 6.10, как отмечено в мастер-плане. 【F:docs/RENOVATION_MASTER_PLAN.md†L23-L26】
