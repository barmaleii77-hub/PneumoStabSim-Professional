...
## [4.9.5] - 2026-12-20
### Changed
- Согласована релизная версия `4.9.5` между конфигурациями, кодом и ключевыми документами.
- Обновлены бейджи и справочные руководства, чтобы ссылаться на актуальный выпуск и гарантировать прохождение проверки консистентности версии.
