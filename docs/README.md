# PneumoStabSim Professional v4.9.6 — Documentation Hub
...
> Эта шпаргалка поддерживается в актуальном состоянии для релиза v4.9.6. Обновляйте её при изменении архитектуры, tooling или путей к ключевым документам.
