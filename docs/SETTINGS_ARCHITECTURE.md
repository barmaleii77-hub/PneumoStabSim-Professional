...
коде. На 2025-01-18 определён блок `geometry`, который используется ядром
...
| `initial_state`         | `frame_height_m` / `frame_beam_size_m` | `0.65` / `0.12`       | Базовые размеры рамы для 3D сцены |
