...
## Dry-run релиза
###1. Сборка артефактов
- Выполнена упаковка проекта `python -m build` с генерацией wheel и sdist (`dist/pneumostabsim-2.0.1-py3-none-any.whl`, `dist/pneumostabsim-2.0.1.tar.gz`). Команда прошла успешно, фиксированы предупреждения setuptools о формате лицензии, влияющих только на будущее обновление метаданных.【79c66c†L1-L116】【c9dd51†L1-L2】
