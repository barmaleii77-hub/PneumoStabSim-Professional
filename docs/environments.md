...
> 📚 Переменные Qt, headless-профили и пошаговые инструкции собраны в
> [`docs/ENVIRONMENT_SETUP.md`](ENVIRONMENT_SETUP.md). Используйте текущий файл
> совместно с новой сводкой: здесь — матрицы и результаты тестов, там — команды и
> настройки.
