...
• Python 3.13.x, PySide6/Qt 6.10.2 (как в логах запуска).
• Qt CLI-утилиты в контейнере: qmllint, qsb (через aqtinstall Qt 6.10.2).
...
1. Dockerfile (debian/bookworm devcontainer) с Xvfb, Mesa, Lavapipe, aqtinstall и Qt 6.10.2.
