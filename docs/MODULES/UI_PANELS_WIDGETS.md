...
- QML `SimulationPanel` экспонирует переключатели кинематика/динамика,
  ...
  полем пользовательского пути и ввод температуры окружающей среды, который
  сразу сохраняется через `SettingsManager` вместе с выбором профилей и
  теплового режима. 【F:assets/qml/Panels/SimulationPanel.qml†L18-L188】【F:assets/qml/Panels/SimulationPanel.qml†L630-L750】
