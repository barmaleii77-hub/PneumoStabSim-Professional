...
- QML `SimulationPanel` экспонирует переключатели кинематика/динамика,
  ...
  пружин/демпферов в кинематике. Также добавлены пресеты профилей дороги с
  полем пользовательского пути и вводом температуры атмосферы; все значения
  сразу отправляются в `SettingsManager` через обработчики сигналов. 【F:assets/qml/Panels/SimulationPanel.qml†L18-L188】【F:assets/qml/Panels/SimulationPanel.qml†L480-L760】
