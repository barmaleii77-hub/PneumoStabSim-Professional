...
def extreme_fog_colors(window):
    ...
    for i, (color, name) in enumerate(colors):
        QTimer.singleShot(i * 1000, lambda c=color, n=name: change_fog_color_extreme(graphics_panel, c, n))
...
def extreme_antialiasing_demo(window):
    ...
    graphics_panel.current_graphics.update({
        'antialiasing': 0,  # No AA
        'aa_quality': 0     # Lowest quality
    })
