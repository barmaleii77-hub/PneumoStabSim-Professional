...
# -*- coding: utf-8 -*-
"""
2-meter suspension system with CORRECT CYLINDRICAL JOINTS along Z-axis
"""
import sys
import os
...
# CORRECTED 2-meter suspension system with Z-axis joints
SUSPENSION_QML = """
import QtQuick
import QtQuick3D
...
View3D {
    ...
    // SUSPENSION COMPONENT WITH CORRECT Z-AXIS JOINTS
    component SuspensionCorner: Node {
        ...
        // ========== CYLINDRICAL JOINTS (CORRECTLY along Z-axis) ==========
        
        // Cylinder tail joint (thick cylindrical hinge at frame) - ROTATED FOR Z-AXIS
        Model {
            source: "#Cylinder"
            position: j_tail
            scale: Qt.vector3d(2.4, 2.4, 1.2)  // Wide cylinder
            eulerRotation: Qt.vector3d(90, 0, 0)  // ROTATE 90deg around X to align with Z-axis
            materials: PrincipledMaterial { baseColor: "#333333"; metalness: 0.9; roughness: 0.2 }
        }
        
        // Lever pivot joint (medium cylindrical hinge at frame) - ROTATED FOR Z-AXIS
        Model {
            source: "#Cylinder"
            position: j_arm
            scale: Qt.vector3d(2.0, 2.0, 1.0)  // Medium cylinder
            eulerRotation: Qt.vector3d(90, 0, 0)  // ROTATE 90deg around X to align with Z-axis
            materials: PrincipledMaterial { baseColor: "#555555"; metalness: 0.9; roughness: 0.2 }
        }
        
        // Rod attachment joint (small cylindrical bushing) - ROTATED FOR Z-AXIS
        Model {
            source: "#Cylinder"
            position: j_rod
            scale: Qt.vector3d(1.6, 1.6, 0.8)  // Small cylinder
            eulerRotation: Qt.vector3d(90, 0, 0)  // ROTATE 90deg around X to align with Z-axis
            materials: PrincipledMaterial { baseColor: "#777777"; metalness: 0.8; roughness: 0.3 }
        }
    }

    // Four suspension corners with CORRECTLY ORIENTED cylindrical joints
    ...
    // Reference markers (smaller, for reference only)
    Model { source: "#Sphere"; position: fl_j_arm; scale: Qt.vector3d(0.6, 0.6, 0.6); materials: PrincipledMaterial { baseColor: "#00ff00"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: fr_j_arm; scale: Qt.vector3d(0.6, 0.6, 0.6); materials: PrincipledMaterial { baseColor: "#00ff00"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: rl_j_arm; scale: Qt.vector3d(0.6, 0.6, 0.6); materials: PrincipledMaterial { baseColor: "#00ff00"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: rr_j_arm; scale: Qt.vector3d(0.6, 0.6, 0.6); materials: PrincipledMaterial { baseColor: "#00ff00"; lighting: PrincipledMaterial.NoLighting } }
    
    Model { source: "#Sphere"; position: fl_j_tail; scale: Qt.vector3d(0.4, 0.4, 0.4); materials: PrincipledMaterial { baseColor: "#0000ff"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: fr_j_tail; scale: Qt.vector3d(0.4, 0.4, 0.4); materials: PrincipledMaterial { baseColor: "#0000ff"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: rl_j_tail; scale: Qt.vector3d(0.4, 0.4, 0.4); materials: PrincipledMaterial { baseColor: "#0000ff"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: rr_j_tail; scale: Qt.vector3d(0.4, 0.4, 0.4); materials: PrincipledMaterial { baseColor: "#0000ff"; lighting: PrincipledMaterial.NoLighting } }
    
    Model { source: "#Sphere"; position: fl_j_rod; scale: Qt.vector3d(0.3, 0.3, 0.3); materials: PrincipledMaterial { baseColor: "#ff0000"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: fr_j_rod; scale: Qt.vector3d(0.3, 0.3, 0.3); materials: PrincipledMaterial { baseColor: "#ff0000"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: rl_j_rod; scale: Qt.vector3d(0.3, 0.3, 0.3); materials: PrincipledMaterial { baseColor: "#ff0000"; lighting: PrincipledMaterial.NoLighting } }
    Model { source: "#Sphere"; position: rr_j_rod; scale: Qt.vector3d(0.3, 0.3, 0.3); materials: PrincipledMaterial { baseColor: "#ff0000"; lighting: PrincipledMaterial.NoLighting } }
    ...
    Component.onCompleted: {
        console.log("=== CORRECTED Z-AXIS CYLINDRICAL JOINTS ===")
        console.log("All joints rotated 90deg around X-axis")
        console.log("Joints now align with Z-axis (longitudinal)")
        console.log("Tail joints: eulerRotation(90,0,0)")
        console.log("Arm joints: eulerRotation(90,0,0)")
        console.log("Rod joints: eulerRotation(90,0,0)")
        view3d.forceActiveFocus()
    }
}
"""

class ZAxisJointsWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        
        self.setWindowTitle("Z-AXIS CYLINDRICAL JOINTS - CORRECTED")
        self.resize(1400, 900)
        
        self.qml_widget = QQuickWidget(self)
        self.qml_widget.setResizeMode(QQuickWidget.SizeRootObjectToView)
        
        qml_path = Path("z_axis_joints.qml")
        ...
        if self.qml_widget.status() == QQuickWidget.Status.Error:
            ...
            print("? Z-axis cylindrical joints loaded successfully")
        
        self.setCentralWidget(self.qml_widget)

def main():
    print("="*60)
    print("Z-AXIS CYLINDRICAL JOINTS - CORRECTED")
    print("="*60)
    print("FIXES:")
    print("Joints rotated 90deg around X-axis")
    print("All cylinders now align with Z-axis")
    print("eulerRotation: Qt.vector3d(90, 0, 0)")
    print("Proper longitudinal orientation")
    print("="*60)
    
    app = QApplication(sys.argv)
    window = ZAxisJointsWindow()
    window.show()
    sys.exit(app.exec())
