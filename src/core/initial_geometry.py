...
def print_initial_geometry_report(geom: InitialGeometry, params: CylinderParams):
    ...
    print(f"  Left j_rod:       ({geom.j_rod_left[0]:.3f}, {geom.j_rod_left[1]:.3f}, {geom.j_rod_left[2]:.3f}) m")
    print(f"  Right j_rod:      ({geom.j_rod_right[0]:.3f}, {geom.j_rod_right[1]:.3f}, {geom.j_rod_right[2]:.3f}) m")
...
if __name__ == "__main__":
    ...
    print("\n?? QML PROPERTY VALUES:")
    print(f"property real pistonPositionMm: {geom.x_piston_0 * 1000:.2f}  // mm from cylinder start")
    print(f"property real pistonRatio: {geom.x_piston_0 / params.L_body:.3f}  // Normalized (0..1)")
    print(f"\n// Left side (FL, RL):")
    print(f"property vector3d fl_j_rod: Qt.vector3d({geom.j_rod_left[0]:.3f}, {geom.j_rod_left[1]:.3f}, {geom.j_rod_left[2]:.3f})")
    print(f"\n// Right side (FR, RR):")
    print(f"property vector3d fr_j_rod: Qt.vector3d({geom.j_rod_right[0]:.3f}, {geom.j_rod_right[1]:.3f}, {geom.j_rod_right[2]:.3f})")
