...
class SimulationPanelAccordion(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.kinematic_options_label.setStyleSheet("color: #aaaaaa; font-size: 9pt; font-weight: bold;")
...
class RoadPanelAccordion(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.manual_label.setStyleSheet("color: #aaaaaa; font-size: 9pt; font-weight: bold;")
        ...
        self.profile_label.setStyleSheet("color: #aaaaaa; font-size: 9pt; font-weight: bold;")
    ...
    def get_parameters(self) -> dict:
        ...
        if is_manual:
            ...
            return {
                'road_mode': 'profile',
                'profile_type': self.profile_type_combo.currentText().lower().replace(' ', '_'),
...
class AdvancedPanelAccordion(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        graphics_label.setStyleSheet("color: #aaaaaa; font-size: 9pt; font-weight: bold;")
