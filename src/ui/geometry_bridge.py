 ...
 *,
 ...
 self._pivot_offset_x = float(visual_constants.get("pivot_offset_x_m",0.15))
 self._tail_offset_x = float(visual_constants.get("tail_offset_x_m",0.1))
 self._piston_clip_min = float(visual_constants.get("piston_clip_min_fraction",0.1))
 self._piston_clip_max = float(visual_constants.get("piston_clip_max_fraction",0.9))
 self._max_stroke_fraction = float(visual_constants.get("max_stroke_fraction",0.4))
 ...
 side_mult = -1.0 if is_left else1.0
 ...
 # Moving parts
 base_angle_rad = math.pi if is_left else0.0
 ...
 "baseAngle": float(180.0 if is_left else0.0),
