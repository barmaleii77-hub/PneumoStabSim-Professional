...
from .defaults import PARAMETER_RANGES, WHEEL_LABELS
...
class RoadExcitationTab(QWidget):
    ...
    def _create_wheels_group(self) -> QGroupBox:
        ...
        # Rear Left
        lr_slider = self._create_wheel_slider(
            "ЛЗ (Left Rear)",
            phase_range,
            'lr_phase'
        )
    ...
    def _create_wheel_slider(self, title: str, phase_range: dict, 
                            param_name: str) -> StandardSlider:
