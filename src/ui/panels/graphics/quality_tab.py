...
class QualityTab(QWidget):
    ...
    def _build_shadow_group(self) -> QGroupBox:
        ...
        enabled.clicked.connect(lambda checked: self._on_control_changed("shadows.enabled", checked))
        ...
        resolution.currentIndexChanged.connect(lambda _: self._on_control_changed("shadows.resolution", resolution.currentData()))
        ...
        shadow_filter.currentIndexChanged.connect(lambda _: self._on_control_changed("shadows.filter", shadow_filter.currentData()))
        ...
        darkness.valueChanged.connect(lambda v: self._on_control_changed("shadows.darkness", v))
    ...
    def _build_antialiasing_group(self) -> QGroupBox:
        ...
        quality_combo.currentIndexChanged.connect(lambda _: self._on_control_changed("antialiasing.quality", quality_combo.currentData()))
        ...
        post_combo.currentIndexChanged.connect(lambda _: self._on_control_changed("antialiasing.post", post_combo.currentData()))
        ...
        taa_check.clicked.connect(lambda checked: self._on_control_changed("taa_enabled", checked))
        ...
        taa_strength.valueChanged.connect(lambda v: self._on_control_changed("taa_strength", v))
        ...
        taa_motion.clicked.connect(lambda checked: self._on_control_changed("taa_motion_adaptive", checked))
        ...
        fxaa_check.clicked.connect(lambda checked: self._on_control_changed("fxaa_enabled", checked))
        ...
        specular_check.clicked.connect(lambda checked: self._on_control_changed("specular_aa", checked))
    ...
    def _build_render_group(self) -> QGroupBox:
        ...
        scale_slider.valueChanged.connect(lambda v: self._on_control_changed("render_scale", v))
        ...
        policy_combo.currentIndexChanged.connect(lambda _: self._on_control_changed("render_policy", policy_combo.currentData()))
        ...
        frame_slider.valueChanged.connect(lambda v: self._on_control_changed("frame_rate_limit", v))
        ...
        dithering_check.clicked.connect(lambda checked: self._on_control_changed("dithering", checked))
        ...
        oit_check.clicked.connect(lambda checked: self._on_control_changed("oit", "weighted" if checked else "none"))
    ...
    def set_state(self, state: Dict[str, Any]):
        ...
        try:
            ...
            if 'taa_motion_adaptive' in state:
                self._controls["taa_motion_adaptive"].setChecked(state['taa_motion_adaptive'])
