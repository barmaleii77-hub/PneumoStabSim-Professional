...
class EffectsTab(QWidget):
    ...
    def _build_bloom_group(self) -> QGroupBox:
        ...
        enabled.clicked.connect(
            lambda checked: self._on_control_changed("bloom_enabled", checked)
        )
        ...
        intensity = LabeledSlider(
            "Интенсивность (glowIntensity)", 0.0, 2.0, 0.02, decimals=2
        )
        intensity.valueChanged.connect(
            lambda v: self._on_control_changed("bloom_intensity", v)
        )
        ...
        threshold = LabeledSlider(
            "Порог (glowHDRMinimumValue)", 0.0, 4.0, 0.05, decimals=2
        )
        threshold.valueChanged.connect(
            lambda v: self._on_control_changed("bloom_threshold", v)
        )
        ...
        spread = LabeledSlider(
            "Распространение (glowBloom)", 0.0, 1.0, 0.01, decimals=2
        )
        spread.valueChanged.connect(
            lambda v: self._on_control_changed("bloom_spread", v)
        )
        ...
        glow_strength = LabeledSlider(
            "Сила свечения (glowStrength)", 0.0, 2.0, 0.02, decimals=2
        )
        glow_strength.valueChanged.connect(
            lambda v: self._on_control_changed("bloom_glow_strength", v)
        )
        ...
        hdr_max = LabeledSlider(
            "HDR Maximum (glowHDRMaximumValue)", 5.0, 20.0, 0.5, decimals=1
        )
        hdr_max.valueChanged.connect(
            lambda v: self._on_control_changed("bloom_hdr_max", v)
        )
        ...
        hdr_scale.valueChanged.connect(
            lambda v: self._on_control_changed("bloom_hdr_scale", v)
        )
        ...
        quality_high.clicked.connect(
            lambda checked: self._on_control_changed("bloom_quality_high", checked)
        )
        ...
        bicubic.clicked.connect(
            lambda checked: self._on_control_changed("bloom_bicubic_upscale", checked)
        )
    ...
    def _build_tonemap_group(self) -> QGroupBox:
        ...
        enabled.clicked.connect(
            lambda checked: self._on_control_changed("tonemap_enabled", checked)
        )
        ...
        combo.currentIndexChanged.connect(
            lambda _: self._on_control_changed("tonemap_mode", combo.currentData())
        )
        ...
        exposure = LabeledSlider(
            "Экспозиция (tonemapExposure)", 0.1, 5.0, 0.05, decimals=2
        )
        exposure.valueChanged.connect(
            lambda v: self._on_control_changed("tonemap_exposure", v)
        )
        ...
        white_point = LabeledSlider(
            "Белая точка (tonemapWhitePoint)", 0.5, 5.0, 0.1, decimals=1
        )
        white_point.valueChanged.connect(
            lambda v: self._on_control_changed("tonemap_white_point", v)
        )
    ...
    def _build_dof_group(self) -> QGroupBox:
        ...
        enabled.clicked.connect(
            lambda checked: self._on_control_changed("depth_of_field", checked)
        )
        ...
        focus = LabeledSlider(
            "Фокусное расстояние", 200.0, 20000.0, 50.0, decimals=0, unit="мм"
        )
        focus.valueChanged.connect(
            lambda v: self._on_control_changed("dof_focus_distance", v)
        )
    ...
    def _build_misc_effects_group(self) -> QGroupBox:
        ...
        motion.clicked.connect(
            lambda checked: self._on_control_changed("motion_blur", checked)
        )
        ...
        motion_strength.valueChanged.connect(
            lambda v: self._on_control_changed("motion_blur_amount", v)
        )
        ...
        lens_flare.clicked.connect(
            lambda checked: self._on_control_changed("lens_flare", checked)
        )
        ...
        lf_ghost_count = LabeledSlider(
            "Количество призраков", 1.0, 10.0, 1.0, decimals=0
        )
        lf_ghost_count.valueChanged.connect(
            lambda v: self._on_control_changed("lens_flare_ghost_count", int(v))
        )
        ...
        lf_dispersal = LabeledSlider(
            "Распределение призраков", 0.0, 1.0, 0.01, decimals=2
        )
        lf_dispersal.valueChanged.connect(
            lambda v: self._on_control_changed("lens_flare_ghost_dispersal", v)
        )
        ...
        lf_halo.valueChanged.connect(
            lambda v: self._on_control_changed("lens_flare_halo_width", v)
        )
        ...
        lf_bloom_bias.valueChanged.connect(
            lambda v: self._on_control_changed("lens_flare_bloom_bias", v)
        )
        ...
        lf_stretch.clicked.connect(
            lambda checked: self._on_control_changed(
                "lens_flare_stretch_to_aspect", checked
            )
        )
        ...
        vignette.clicked.connect(
            lambda checked: self._on_control_changed("vignette", checked)
        )
        ...
        vignette_strength.valueChanged.connect(
            lambda v: self._on_control_changed("vignette_strength", v)
        )
        ...
        vignette_radius.valueChanged.connect(
            lambda v: self._on_control_changed("vignette_radius", v)
        )
    ...
    def _build_color_adjustments_group(self) -> QGroupBox:
        ...
        brightness.valueChanged.connect(
            lambda v: self._on_control_changed("adjustment_brightness", v)
        )
        ...
        contrast.valueChanged.connect(
            lambda v: self._on_control_changed("adjustment_contrast", v)
        )
        ...
        saturation.valueChanged.connect(
            lambda v: self._on_control_changed("adjustment_saturation", v)
        )
    ...
    def get_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "bloom_bicubic_upscale": self._controls[
            ...
            "lens_flare_ghost_count": int(
                self._controls["lens_flare.ghost_count"].value()
            ),
            "lens_flare_ghost_dispersal": self._controls[
            ...
            "lens_flare_stretch_to_aspect": self._controls[
                "lens_flare.stretch"
            ].isChecked(),
    ...
    def set_state(self, state: Dict[str, Any]):
        ...
        try:
            ...
            if "bloom_glow_strength" in state:
                self._controls["bloom.glow_strength"].set_value(
                    state["bloom_glow_strength"]
                )
            ...
            if "bloom_quality_high" in state:
                self._controls["bloom.quality_high"].setChecked(
                    state["bloom_quality_high"]
                )
            if "bloom_bicubic_upscale" in state:
                self._controls["bloom.bicubic_upscale"].setChecked(
                    state["bloom_bicubic_upscale"]
                )
            ...
            if "tonemap_white_point" in state:
                self._controls["tonemap.white_point"].set_value(
                    state["tonemap_white_point"]
                )
            ...
            if "lens_flare_ghost_count" in state:
                self._controls["lens_flare.ghost_count"].set_value(
                    float(state["lens_flare_ghost_count"])
                )
            if "lens_flare_ghost_dispersal" in state:
                self._controls["lens_flare.ghost_dispersal"].set_value(
                    state["lens_flare_ghost_dispersal"]
                )
            if "lens_flare_halo_width" in state:
                self._controls["lens_flare.halo_width"].set_value(
                    state["lens_flare_halo_width"]
                )
            if "lens_flare_bloom_bias" in state:
                self._controls["lens_flare.bloom_bias"].set_value(
                    state["lens_flare_bloom_bias"]
                )
            if "lens_flare_stretch_to_aspect" in state:
                self._controls["lens_flare.stretch"].setChecked(
                    state["lens_flare_stretch_to_aspect"]
                )
            ...
            if "vignette_strength" in state:
                self._controls["vignette.strength"].set_value(
            ...
            if "adjustment_brightness" in state:
                self._controls["color.brightness"].set_value(
                    state["adjustment_brightness"]
                )
            ...
            if "adjustment_saturation" in state:
                self._controls["color.saturation"].set_value(
                    state["adjustment_saturation"]
                )
