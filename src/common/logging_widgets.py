...
class LoggingCheckBox(QCheckBox):
    ...
    def __init__(self, text: str, widget_name: str, parent=None):
        ...
        self.stateChanged.connect(self._on_state_changed_with_logging, Qt.ConnectionType.DirectConnection)
...
class LoggingComboBox(QComboBox):
    ...
    def __init__(self, widget_name: str, parent=None):
        ...
        self.currentIndexChanged.connect(self._on_index_changed_with_logging, Qt.ConnectionType.DirectConnection)
...
class LoggingSlider(QSlider):
    ...
    def __init__(self, widget_name: str, orientation, parent=None):
        ...
        # Подключаем логирование
        self.valueChanged.connect(self._on_value_changed_with_logging, Qt.ConnectionType.DirectConnection)
