...
class LoggingLabeledSlider:
    ...
    def _on_value_changed_with_logging(self, value: float):
        ...
        self.event_logger.log_user_slider(
            ...
            old_value=self._previous_value if self._previous_value is not None else value,
            new_value=value,
...
class LoggingColorButton:
    ...
    def _on_color_changed_with_logging(self, color: str):
        ...
        self.event_logger.log_user_color(
            ...
            old_color=self._previous_color if self._previous_color is not None else color,
            new_color=color
        )
...
def create_logging_slider(title: str, minimum: float, maximum: float, step: float,
                          widget_name: str, *, decimals: int = 2, unit: str | None = None,
    ...
    base_slider = LabeledSlider(title, minimum, maximum, step, decimals=decimals, unit=unit, parent=parent)
