...
def create_maneuver_preset(maneuver_type: str = 'double_lane_change',
                          velocity: float = 20.0, duration: float = 30.0) -> Preset:
...
def create_test_preset(test_type: str = 'pothole', velocity: float = 16.7, 
                      duration: float = 20.0) -> Preset:
...
def get_all_presets() -> Dict[str, Preset]:
    ...
    # Maneuver presets
    presets['dlc_72kmh'] = create_maneuver_preset('double_lane_change', velocity=20.0, duration=30.0)
    presets['sine_sweep'] = create_maneuver_preset('sine_sweep', velocity=16.7, duration=20.0)
    presets['step_steer'] = create_maneuver_preset('step_steer', velocity=16.7, duration=15.0)
    
    # Test presets
    presets['test_pothole'] = create_test_preset('pothole', velocity=16.7, duration=20.0)
    presets['test_speed_bump'] = create_test_preset('speed_bump', velocity=8.3, duration=20.0)
...
__all__ = [
    'create_highway_preset', 'create_urban_preset', 'create_offroad_preset',
    'create_maneuver_preset', 'create_test_preset',
    'get_all_presets', 'get_preset_by_name', 'list_preset_names', 'get_presets_by_category',
    'ISO3888_DLC_GEOMETRY', 'TRL_SPEED_BUMP_SPECS'
]