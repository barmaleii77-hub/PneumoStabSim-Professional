...
| `comprehensive_test.py` | Расширенный тест-раннер: выполняет Python-тесты, сборку .NET-решения и формирует лог в `logs/`. |
...
| `create_solution.py` | Генерирует/обновляет Visual Studio Solution на основе актуального состава проектов. |
